...
export interface DetailExampleItem {
  name: string;
  id: number;
}

// TODO: replace this with real data from your application
const EXAMPLE_DATA: DetailExampleItem[] = [
  {id: 1, name: 'Hydrogen'},
  {id: 2, name: 'Helium'},
  {id: 3, name: 'Lithium'},
  {id: 4, name: 'Beryllium'},
...
/**
 * Data source for the DetailExample view. This class should
...
export class DetailExampleDataSource extends DataSource<DetailExampleItem> {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: DetailExampleItem[]) {
